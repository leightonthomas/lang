...
class ApplicationTest extends TestCase
{
    ...
    public function itWillDetermineIfItContainsAnotherVariable(): void
    {
        ...
        self::assertFalse($instance->contains(new Variable(TypeInferer::FUNCTION_APPLICATION)));
    ...
    public static function equalProvider(): array
    {
        return [
            ...
            [
                new Variable(TypeInferer::FUNCTION_APPLICATION),
                false,
            ],
            [
                new Application(TypeInferer::FUNCTION_APPLICATION, []),
                false,
            ],
            [
                new Application(TypeInferer::FUNCTION_APPLICATION, [new Variable('x_0')]),
                false,
            ],
            [
            ...
            [
                new Application(TypeInferer::FUNCTION_APPLICATION, [new Variable('x_0'), new Variable('x_2')]),
                false,
            ],
            [
                new Application(
            ...
            [
                new Application(TypeInferer::FUNCTION_APPLICATION, [new Variable('x_0'), new Variable('x_1')]),
                true,
            ],
        ];
    }
